...
>
> 최종 갱신: 2026-09-10 / 커밋 `f6dd45f` (적 강인도) 이후
...
| 파일 | 내용 |
|---|---|
| `assets/textures/player.png` | 384x576. 6열 x 9행 = idle / run / light / roll / crouch / thrust / runatk / **crawl(4) / bite(6)** |
...
| # | 내용 |
|---|---|
| **6-c-8** | ★ 플랫포머 전환 — 중력 · 지면 · 점프(상태) · 점프 공격 ← 여기서 이어간다 |
